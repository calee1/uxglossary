...
import { LogOut, Settings, Database, Users, BarChart3 } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="p-4 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg">
                <h3 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">Data Statistics</h3>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
                <h3 className="font-semibold text-green-800 dark:text-green-200 mb-2">GitHub Integration</h3>
                <p className="text-sm text-green-700 dark:text-green-300 mb-3">
                  Configure GitHub repository for data storage and version control.
                </p>
                <Button variant="outline" size="sm" onClick={() => setShowSetupWizard(true)} className="w-full">
