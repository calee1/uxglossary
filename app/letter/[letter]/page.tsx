...
export default async function LetterPage({ params }: LetterPageProps) {
  ...
  return (
    <main className="max-w-4xl mx-auto p-4 sm:p-6 border rounded-lg my-4 sm:my-8 bg-white">
      ...
      <div className="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-9 lg:grid-cols-13 gap-1 sm:gap-2 justify-items-center my-4 sm:my-6 p-3 sm:p-4 bg-gray-50 rounded-lg">
      ...
      <div className="relative w-full max-w-2xl mx-auto mb-6 sm:mb-8">
        <div className="relative">
          ...
          <Input
            ...
            className="pl-8 sm:pl-10 pr-4 py-2 sm:py-3 text-base sm:text-lg border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200"
          />
        </div>
      </div>
